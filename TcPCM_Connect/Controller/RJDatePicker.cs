...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = TcPCM_Connect.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = TcPCM_Connect.Properties.Resources.calendarDark;
                else calendarIcon = TcPCM_Connect.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            if (this.Name.ToLower().Contains("start")) this.Value = DateTime.Today.AddMonths(-1);
        }
